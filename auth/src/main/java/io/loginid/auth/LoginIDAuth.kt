package io.loginid.auth

import android.app.Activity
import android.content.Context
import android.view.View
import io.loginid.auth.controllers.OTP
import io.loginid.auth.controllers.PasskeyManager
import io.loginid.auth.controllers.Passkeys
import io.loginid.auth.controllers.Utils
import io.loginid.auth.models.AuthResult
import io.loginid.auth.models.AuthenticateWithPasskeyOptions
...
import io.loginid.auth.models.TxConfirmResult
...
import io.loginid.core.services.OTPService
import io.loginid.core.services.PasskeyManagerService
import io.loginid.core.services.PasskeyService
...
class LoginIDAuth(config: LoginIDConfig) {
     ...
     * @throws io.loginid.core.errors.LoginIDError if passkey creation fails.
     */
     ...
     * @throws io.loginid.core.errors.LoginIDError if authentication fails.
     */
     ...
     * @param options Optional parameters for passkey authentication.
     * @return An [AuthResult] containing an authorization token if authentication is successful.
     * @throws io.loginid.core.errors.LoginIDError if authentication fails or is canceled.
     */
     ...
     * @throws io.loginid.core.errors.LoginIDError if the transaction confirmation fails or is canceled.
     */
     ...
     * @throws io.loginid.core.errors.LoginIDError if the user is not authenticated or the request fails.
     */
     ...
     * @throws io.loginid.core.errors.LoginIDError if the request fails.
     */
     ...
     * @throws io.loginid.core.errors.LoginIDError if validation fails.
     */
     ...
     * @param options Optional parameters to customize the request, such as `usernameType`.
     * @throws io.loginid.core.errors.LoginIDError if the OTP cannot be sent.
     */
